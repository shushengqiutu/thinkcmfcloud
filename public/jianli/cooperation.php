<?php
	...
	$smtpusermail = "867329774@qq.com";//SMTP服务器的用户邮箱
	//$smtpemailto = $_POST['toemail'];//发送给谁
	$smtpemailto = "daijiuhu@6cloudtech.com";//发送给谁

	$smtpuser = "867329774@qq.com";//SMTP服务器的用户帐号，注：部分邮箱只需@前面的用户名
	$smtppass = "aawtbkdcpmzpbecd";//SMTP服务器的用户密码
